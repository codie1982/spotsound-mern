...
var verify = asyncHandler(/*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (nUser) {
            if (!nUser.email_verify) {
              mailController.mailVerify(email).then(function (result) {
                res.status(200).json(preparedata({
                  mail_verify_code: result.code,
                  expire_time: result.expireTime
                }, 200, "mail kodu başarı ile gönderildi."));
              })["catch"](function (err) {
        ...
        case 8:
          ...
          res.status(400).json(preparedata(_context.t0, 400, "mail verify error"));
        case 11:
        case "end":
...
var aprove = asyncHandler(/*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, code, setconnection, _setConnectioon, userAgent, ip, sessionid, _code, isVerify, userEmail, nUser, userid, userToken, geo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, code = _req$body.code, setconnection = _req$body.setconnection;
          _setConnectioon = setconnection != null ? setconnection : false;
        ...
        case 8:
          _context2.prev = 8;
          _code = new Number(code);
          _context2.next = 12;
          return mailVerifyDbmap.isApprove(parseInt(_code));
        case 12:
          ...
          _context2.next = 16;
          return mailVerifyDbmap.getMailFromCode(parseInt(_code));
        case 16:
          userEmail = _context2.sent;
          _context2.next = 19;
          return userDbmap.getUserFromMail(userEmail);
        case 19:
          ...
          userid = nUser._id;
          _context2.next = 24;
          return userDbmap.setVerifyMail(userid);
        case 24:
          if (!_setConnectioon) {
            _context2.next = 33;
            break;
        ...
        case 29:
          req.session.user = {
            name: nUser.firstname,
            image: nUser.profileImage.path,
            token: userToken,
        ...
        case 39:
          ...
          res.status(400).json(preparedata(_context2.t0, 400, "mail verify error"));
        case 42:
        case "end":
