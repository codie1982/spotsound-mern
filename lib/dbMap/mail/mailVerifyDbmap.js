...
var isApprove = /*#__PURE__*/function () {
  ...
  return function isApprove(_x) {
    return _ref.apply(this, arguments);
  };
}();
var getMailFromCode = /*#__PURE__*/function () {
  ...
  return function getMailFromCode(_x2) {
...
function isExpired(createdAt, expireTime) {
  ...
  var expirationDate = new Date(createdDate.getTime() + expireTime);
...
module.exports = {
  isApprove: isApprove,
  getMailFromCode: getMailFromCode
};